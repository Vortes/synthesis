...
As noted in your `PROJECT_STRUCTURE.md`, to properly support a Staging environment alongside Production, you should decouple the _build minification mode_ from the _environment data_.
